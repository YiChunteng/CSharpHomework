...
namespace OrderForm
{
    public partial class FormEdit : Form
    {
        ...
        {
            InitializeComponent();
            Customer customer1 = new Customer("3", "liuwang");
            Customer customer2 = new Customer("4", "jams");

            Goods apple = new Goods("4", "apple", 5.59);
            Goods egg = new Goods("5", "egg", 4.99);
            Goods milk = new Goods("6", "milk", 69.9);
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			((OrderDetail)detailsBindingSource.Current).GoodsName = ((Goods)comboBox2.SelectedItem).Name;
			
		}

        private void button1_Click(object sender, EventArgs e)
        {
			((OrderDetail)detailsBindingSource.Current).AmountMoney = 
				((Goods)comboBox2.SelectedItem).Price * ((OrderDetail)detailsBindingSource.Current).Quantity;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			((Order)orderBindingSource.Current).custumerName = comboBox1.Text;
		}
        ...
        private void FormEdit_Load(object sender, EventArgs e)
        {
			...
			//((Customer)comboBox2.SelectedItem).Name = 
   //             ((Order)orderBindingSource.Current).custumerName;
        }
    }
}
