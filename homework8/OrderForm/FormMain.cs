...
namespace OrderForm
{
    public partial class FormMain : Form
    {
        ...
        public void init()
        {
            ...
            Order order2 = new Order(2, customer2, "15622585555");
            Order order3 = new Order(3, customer2, "15622584444");
		...
		private void button2_Click(object sender, EventArgs e)
		{
			...
			orderService.Export(@"..\..\start.xml");
			XslCompiledTransform trans = new XslCompiledTransform();
			trans.Load(@"..\..\start.xsl");
			trans.Transform(@"..\..\start.xml", @"..\..\start.html");
