...
namespace ordertest {
    ...
    public class Order {
        ...
        public Order(uint orderId, Customer customer, string phone) {
            //Id = orderId;
			DateTime dateTime = DateTime.Now;
			int xyz = dateTime.Year % 2000;
			string orderIdd = xyz.ToString() + dateTime.Month.ToString() + dateTime.Day.ToString()
				+ "00" + orderId.ToString();
			uint orderId1 = uint.Parse(orderIdd);
			Id = orderId1;
			PhoneNum = phone;
            Customer = customer;
        }
